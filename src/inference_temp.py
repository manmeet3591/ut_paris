...
input_tensor_ = input_tensor.contiguous().view(1, 6, 720, 960)


print('Reshaped input tensor shape: ', input_tensor_.shape)

original_shape_tensor = input_tensor_.reshape(1, 6, 720, 960)
...
predicted_sr_ = predicted_sr.cpu().numpy().reshape(1, 31, 720, 960)
